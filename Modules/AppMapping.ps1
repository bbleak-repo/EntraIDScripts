<#
.SYNOPSIS
    Application-to-group mapping module for Okta migration readiness tool.

.DESCRIPTION
    Provides optional application-level readiness visibility by mapping Okta applications
...
function Import-AppMapping {
    <#
    .SYNOPSIS
        Load an optional CSV that maps Okta applications to AD groups.
